...
<script>
    clientes = [];
        ...
        function envia(cod, fec,sub,igvv,tot){ 
        
   	opener.document.form2.cod_co.value = cod; 
   	opener.document.form2.fec_co.value = fec;
...
<body>
    ...
    <h2 class="display-4 text-center py-5">Buscar Cotizacion</h2>
...
<%
                ...
                try{
                    ...
                    rs = st.executeQuery("select * from cotizacion");
